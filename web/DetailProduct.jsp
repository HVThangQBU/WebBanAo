<%-- 
    ...
    Created on : Oct 26, 2022, 2:09:23 PM
    Author     : HOANG_THANG
--%>
                            ...
                            <div class="row">
                                ...
                                <aside class="col-sm-5 border-right">
                                    <article class="gallery-wrap"> 
                                        <div class="img-big-wrap">
                                            <div> <a href="#"><img src="${detailProduct.image}"></a></div>
                                        </div> <!-- slider-product.// -->
                                ...
                                <aside class="col-sm-7">
                                    <article class="card-body p-5">
                                        <h3 class="title mb-3">${detailProduct.pname}</h3>

                                        <p class="price-detail-wrap"> 
                                            <span class="price h3 text-warning"> 
                                                <span class="currency">US $</span><span class="num">${detailProduct.price}</span>
                                            </span> 
                                        </p> <!-- price-detail-wrap .// -->
